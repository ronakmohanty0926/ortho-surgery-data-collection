function [h, coordinates] = DisplayDeviceState(device, state, option)
...
AnnotateDeviceParameters(device,state,coordinates);

% Display axes
line([0 0.5*Rng], [0 0], [0 0], 'Color','red', 'LineWidth', 4);
line([0 0], [0 0.5*Rng], [0 0], 'Color','green', 'LineWidth', 4);
line([0 0], [0 0], [0 0.5*Rng], 'Color','blue', 'LineWidth', 4);
